...
def post(post_id):
    post = Post.query.get_or_404(post_id) # return 404 if id doesn't exist
...
def update_post(post_id):
    ...
    # ONLY user who wrote the post can update
...
def reset_request():
        ...
        if form.validate_on_submit():
            ...
            flash('Email with instructions on how to reset your password has been sent', 'info')
            return redirect(url_for('login'))
        return render_template('reset_request.html', title='Reset Password', form=form)

# enter token to verify user
